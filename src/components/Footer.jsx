  ...
  return (
    <>
      <div className="w-full min-h-[475px] pt-12 md:pt-0 relative overflow-hidden">
        <div className="max-w-[400px] w-full mx-auto px-3 flex flex-col items-center">
          ...
          <ul className="flex gap-2 mt-6 sm:mt-0 relative z-[2]">
            <li>
              <a
        ...
        <div className="absolute bottom-0 bg-footerbg bg-cover w-full bg-no-repeat bg-center h-[340px]">
          <img
